...
import progetto2023_47.parser.ast.*;

import static java.util.Objects.requireNonNull;
import static progetto2023_47.parser.TokenType.*;
...
public class MyLangParser implements Parser {
	...
	private ForeachStmt parseForeachStmt() throws ParserException {
		consume(FOREACH);
		final var iterator = parseVariable();
		consume(IN);
		final var exp = parseExp();
		return new ForeachStmt(iterator, exp, parseBlock());
	}
	...
	/*
	 * parses vectors Atom ::= '[' Exp ';' Exp ']'
	 */
	private VectLiteral parseVect() throws ParserException {
		consume(OPEN_VECT);
